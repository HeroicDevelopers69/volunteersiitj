...
const ErrorMessage = ({ title, message, state }) => {
    ...
    return (
        <div className="fixed top-0 left-1/2 transform -translate-x-1/2 z-50">
            <motion.div
                className="bg-gradient-to-r from-white to-gray-50 text-red-500 shadow-lg py-2 flex flex-col items-center border border-gray-800 shadow-white/25 dark:shadow-black/75"
