...
const Card = ({advertisement}) => {
  ...
  return (
    <div className='max-w-96 dark:text-white dark:bg-black w-full duration-100 hover:scale-[1.01] font-roboto shadow-2xl shadow-black/75 dark:shadow-white/25 dark:shadow-xl hover:animate-glow transition-shadow dark:border-white dark:hover:animate-glowd'>
