...
export const UndoButton = ({ onClick, disabled }) => (
  <button
    onClick={onClick}
    className='w-full bg-blue-500 text-white py-2 px-4 rounded-md shadow-md hover:bg-blue-600 active:scale-95 disabled:bg-blue-900 disabled:active:scale-100'
    disabled={disabled}
  >
