...
const AboutUs = () => {
    return (
        <div className="mt-[50px] shadow-md rounded-sm shadow-black/75 dark:shadow-white/25 relative h-auto bg-gradient-to-br from-gray-100 via-gray-300 to-gray-500 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 p-10">
            {/* Header Section */}
