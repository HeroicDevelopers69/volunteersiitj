    ...
    <>
      ...
      <div className='w-full h-screen -mt-9 flex flex-col justify-center items-center gap-6 bg-transparent text-white z-10'>
        ...
        <div>
          <Link
            to="/login"
            className='hover:underline underline-offset-2 p-2 transition-transform duration-100 hover:scale-105'
          >
            LogIn
          </Link>
          <Link
            to="/signup"
            className='ml-4 hover:underline underline-offset-2 p-2 transition-transform duration-100 hover:scale-105'
          >
            SignUp
          </Link>
        </div>
